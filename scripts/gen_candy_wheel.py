...
candy_categories = [
    {"name": "Chocolate", "color": "#7b5544", "light": "#bfa294",
     "notes": ["Milk Cocoa", "Dark Cocoa", "Fudge"]},
    {"name": "Caramel", "color": "#d99a3f", "light": "#eecfa0",
     "notes": ["Butterscotch", "Toffee", "Burnt Sugar"]},
    {"name": "Nutty", "color": "#b98a52", "light": "#dcc39a",
     "notes": ["Peanut", "Almond", "Roasted"]},
    {"name": "Malt", "color": "#c9b072", "light": "#e6d9b6",
     "notes": ["Nougat", "Wafer", "Biscuit"]},
    {"name": "Fruit", "color": "#c46a86", "light": "#e5b6c4",
     "notes": ["Berry", "Citrus", "Green Apple"]},
    {"name": "Sour", "color": "#8fae4a", "light": "#c7d89a",
     "notes": ["Citric", "Tart", "Pucker"]},
]
...
tequila_svg = build_wheel(290, 290, candy_categories, "CANDY")
mezcal_svg = build_wheel(290, 290, whisky_categories, "WHISKY")

with open(f"{BASE}/candy_wheel.svg", "w") as f:
    f.write(f'<svg viewBox="0 0 580 580" xmlns="http://www.w3.org/2000/svg">{tequila_svg}</svg>')

with open(f"{BASE}/whisky_wheel2.svg", "w") as f:

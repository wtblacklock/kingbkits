...
AGAVE_ICON = """<svg viewBox="0 0 64 28" style="width:2.3em;height:1em;">
  <rect x="2" y="10" width="30" height="11" rx="5.5" fill="#a9764a"/>
  <rect x="2" y="15.5" width="30" height="5.5" rx="2.7" fill="#000" opacity="0.12"/>
  <rect x="12" y="8.6" width="7.5" height="13.8" rx="1.3" fill="#e5b85c"/>
  <rect x="12" y="8.6" width="7.5" height="3" fill="#b6862c"/>
  <ellipse cx="35" cy="15.5" rx="6" ry="6.3" fill="#ff7a3d"/>
  <ellipse cx="35.7" cy="15.5" rx="3" ry="3.2" fill="#ffcf94"/>
  <path d="M46 5 H60 L57.6 18.6 Q57.1 21.6 53 21.6 Q48.9 21.6 48.4 18.6 Z"
        fill="none" stroke="#8a7663" stroke-width="1.5"/>
  <path d="M47.2 11.4 H58.8 L57.6 18.6 Q57.1 21.6 53 21.6 Q48.9 21.6 48.4 18.6 Z" fill="#c98a2c"/>
  <path d="M47.2 11.4 H58.8 L58.4 13.9 H47.6 Z" fill="#e0ab4e"/>
</svg>"""
...
<style>
  ...
  *{box-sizing:border-box; margin:0; padding:0;}
  ...
  .inv h1{font-weight:300; font-size:1.95rem; color:#000; text-align:center; line-height:1.02;
  ...
  .sq h1{font-weight:300; font-size:84px; color:#f6e9d6; line-height:1.0; margin-top:14px;}
...
<div class="inv">
  ...
  <div class="body">
    ...
    <h1>Cigar &amp; Whisky<br>Night</h1>
    <div class="tag">One cigar. Three pours.</div>
    <hr class="rule">
    ...
    <div class="foot">
      One cigar each for the whole night, tasted against <b>three whisky pours</b>.<br>
      Outdoors. Dress sharp-casual. Come hungry, we'll feed you.
    </div>
  </div>
</div>"""


html = f"""<!doctype html><html><head><meta charset="utf-8"><title>Cigar &amp; Whisky Night Invite</title>{CSS}</head><body>
...
with open(f"{BASE}/kingbkits-cigar-invite.html", "w") as f:
    f.write(html)
...
<div class="sq">
  ...
  <div class="in">
    ...
    <div class="foot">CIGAR &amp; WHISKY PAIRING &nbsp;·&nbsp; ONE CIGAR &nbsp;·&nbsp; THREE POURS</div>
  </div>
</div>
</body></html>"""

with open(f"{BASE}/cigar-invite-square.html", "w") as f:
    f.write(sq)
